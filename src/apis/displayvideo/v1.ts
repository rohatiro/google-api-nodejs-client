...
export namespace displayvideo_v1 {
  ...
  export interface Schema$FirstAndThirdPartyAudience {
    ...
    /**
     * Output only. The description of the first and third party audience.  Only applicable to first party audiences.
     */
    ...
    /**
     * Output only. The duration in days that an entry remains in the audience after the qualifying event.  Only applicable to first party audiences.
     */
